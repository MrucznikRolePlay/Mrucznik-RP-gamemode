...
{
	new var0 = 0;
	if(strcmp(arg1, "@rece", true, 2147483647) == 0)
	{
		SetPlayerSpecialAction(playerid, 10);
		SetPVarInt(playerid, "anim_do", 1);
		return 1;
	}
	if(strcmp(arg1, "@stopanim", true, 2147483647) == 0)
	{
	...
	if(strcmp(arg1, "@waledochodze", true, 2147483647) == 0)
	{
		ApplyAnimation(playerid, "PAULNMAC", "wank_out", 4.0999, 0, 0, 0, 0, 0, 0);
		SetPVarInt(playerid, "anim_do", 1);
		return 1;
	}
	if(strcmp(arg1, "@walekonia", true, 2147483647) == 0)
	{
