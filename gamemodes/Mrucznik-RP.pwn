	...
	{//poprawne has≥o
		...
		if(PlayerInfo[playerid][pCash] < 0)
		{
			...
			if(PlayerInfo[playerid][pWL] < 9)
			{
				...
				sendTipMessage(playerid, "Twoje d≥ugi zaprowadzi≥y CiÍ po kolejne listy goÒcze!"); 
			}
			if(PlayerInfo[playerid][pWL] >= 9)
			{
				PlayerInfo[playerid][pWL] = 10; 
				sendTipMessage(playerid, "Masz juø 10 listÛw goÒczych! CzÍúÊ z nich jest spowodowana d≥ugami! ZrÛb coú z tym!"); 
			}
			DajKase(playerid, 0);
		}
		if(PlayerInfo[playerid][pCash] > 0)
