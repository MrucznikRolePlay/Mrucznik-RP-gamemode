...
public OnGameModeInit()
{
	...
	SetNameTagDrawDistance(20.0); //Wyúwietlanie nickÛw od 20 metrÛw
...
SetPlayerSpawnWeapon(playerid)
{
	...
	{
		sendErrorMessage(playerid, "Twoje HP zosta≥o zbugowane. Zg≥oú to do Komisji ds. UlepszeÒ!");
		sendTipMessage(playerid, "PrzywrÛcono domyúlnπ wartoúÊ Health na 50.0"); 
