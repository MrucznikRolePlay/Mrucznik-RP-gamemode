	...
	if(GetPVarInt(playerid, "RozpoczalBieg") == 1)
	{
		if(GetPVarInt(playerid, "WybralBieg") == 1)
		{
			if(OszukujewBiegu[playerid] == 0)
			{
				...
				{
					CreateNewRunCheckPoint(playerid, 1625.7415,-1608.9004,13.7188, 3, "Zaliczy≥eú trzeci przystanek, kolejny jest juø oznaczony!", 5); 
				}
		...
		else if(GetPVarInt(playerid, "WybralBieg") == 2)
		{
			...
			if(GetPVarInt(playerid, "ZaliczylBaze") == 2)
			{
				CreateNewRunCheckPoint(playerid,  317.4830,-1632.8326,33.3125, 2, "Zaliczy≥eú trzeci checkpoint! NastÍpny zosta≥ oznaczony, a ty siÍ nie poddajesz!", 5); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 3)
			{
			...
			if(GetPVarInt(playerid, "ZaliczylBaze") == 4)
			{
				CreateNewRunCheckPoint(playerid,  664.4612,-1859.3246,5.4609, 2, "Zaliczy≥eú Piπty checkpoint! Zosta≥y jeszcze dwa!", 5); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 5)
			{
			...
			if(GetPVarInt(playerid, "ZaliczylBaze") == 6)
			{
				CreateNewRunCheckPoint(playerid,  1000.8669,-1857.4419,12.8146, 2, "Zaliczy≥eú siÛdmy checkpoint! Juø widaÊ ostatni", 5); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 7)//Ostatni
			{
