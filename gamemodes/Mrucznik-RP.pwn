...
SetPlayerSpawnPos(playerid)
{
    ...
    else
    {
		...
		if(GetPVarInt(playerid, "spawn") == 2)
		{
			...
			if(PlayerInfo[playerid][pLocal] == 108)
			{
				sendTipMessage(playerid, "W urzÍdzie miasta nie wolno mieÊ broni! Zostanie Ci ona przywrÛcona po úmierci.");
				SetPVarInt(playerid, "mozeUsunacBronie", 1);
                ResetPlayerWeapons(playerid);
				return 1;
			}
        	...
        	if(CarData[lcarid][c_OwnerType] == CAR_OWNER_SPECIAL)
        	{
 				if(CarData[lcarid][c_Owner] == RENT_CAR)
    			{
					if (CarData[lcarid][c_Rang]-1 != playerid)
					{
						...
						ShowPlayerDialogEx(playerid, 7079, DIALOG_STYLE_MSGBOX, "Wypoøyczalnia pojazdÛw", "Moøesz wypoøyczyÊ ten pojazd!\nCena: 30.000$ za 15 minut.", "Wynajmij", "Wyjdü");
					}
				}
			}
		}
				...
				else
				{
					if(TransportDuty[i] == 1)
					{
                        ...
                        if(PlayerInfo[playerid][pLevel] < 3)
                        {
                            ...
                            sendTipMessageEx(playerid, COLOR_LIGHTBLUE, "Jesteú nowym graczem, obowiπzuje Cie rabat 50 procent na taksÛwkÍ.");
                        }
                        else
                        {
				...
				if(PlayerInfo[i][pPayDay] >= 5)
				{
					...
					if(PlayerInfo[i][pPbiskey] >= 0 && PlayerInfo[i][pPbiskey] <= MAX_BIZNES)
					{
						...
						if(losuj == 1 || losuj == 2 || losuj == 3)//Max kwota
						{
							...
							SendClientMessage(i, COLOR_WHITE, string);
							SendClientMessage(i, COLOR_WHITE, "TwÛj dochÛd z biznesu {37AC45}osiπgnπ≥ maksimum"); 
						...
						if(losuj == 4 || losuj == 5 || losuj == 6 || losuj == 7)//Po≥owiczny zysk
						{
							...
							SendClientMessage(i, COLOR_WHITE, string);
							SendClientMessage(i, COLOR_WHITE, "TwÛj dochÛd z biznesu {37AC45}osiπgnπ≥ po≥owÍ"); 
							SendClientMessage(i, COLOR_LIGHTBLUE, "|_________________________|");
						...
						if(losuj == 8 || losuj == 9)//minimalna strata
						{
							...
							SendClientMessage(i, COLOR_WHITE, string);
							SendClientMessage(i, COLOR_WHITE, "TwÛj biznes przyniÛs≥ {FF0000}minimalne straty"); 
							SendClientMessage(i, COLOR_LIGHTBLUE, "|_________________________|");
							...
							else
							{
								...
								{
									sendTipMessageEx(i, COLOR_RED, "Twoje d≥ugi rosnπ! TwÛj biznes przynosi kolejne straty"); 
								}
							}
						...
						if(losuj == 10)//Duøa strata
						{
							...
							SendClientMessage(i, COLOR_WHITE, string);
							SendClientMessage(i, COLOR_WHITE, "TwÛj biznes przyniÛs≥ {FF0000}duøe straty"); 
							SendClientMessage(i, COLOR_LIGHTBLUE, "|_________________________|");
...
public OnPlayerText(playerid, text[])
{
	...
	if (realchat)
	{
		...
		else//Jeøeli jest na admin duty
		{
