...
public OnPlayerSpawn(playerid)
{
	...
	sendTipMessage(playerid, "SPRAWDZI£EM CZY JESTEå ZALOGOWANY");
	DeletePVar(playerid, "Vinyl-bilet");
    DeletePVar(playerid, "Vinyl-VIP");
    PlayerInfo[playerid][pMuted] = 0;
	WnetrzeWozu[playerid] = 0;
	spamwl[playerid] = 0;
	sendTipMessage(playerid, "SPRAWDZI£EM JAKIEå G”WNO");
	...
	sendTipMessage(playerid, "Jakieú gÛwno z usuwania - wykona≥em");
	...
	sendTipMessage(playerid, "Ustali≥em düwiÍki i da≥em cos");

	//Kubi
	INT_AirTowerLS_Exit(playerid, false, true);
	sendTipMessage(playerid, "JebaÊ Kubiego");
