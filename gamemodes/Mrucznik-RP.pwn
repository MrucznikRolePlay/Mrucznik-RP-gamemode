	...
	else
	{
		...
		if(PRESSED(KEY_FIRE))
		{
			if(GetPlayerWeapon(playerid) == 46)
			{
				...
				{
					new string[144];
					format(string, sizeof(string), "Pojazd w pobliøu: %d", vehicleid); //debug
					SendClientMessage(playerid, COLOR_PANICRED, string);
					new Float:vhealth;
        			SendClientMessage(playerid, COLOR_PANICRED, "Schowaj spadochron zanim w coú uderzysz.");
					//SetPlayerArmedWeapon(playerid, 0); //chowanie spadochronu lub zabraÊ
