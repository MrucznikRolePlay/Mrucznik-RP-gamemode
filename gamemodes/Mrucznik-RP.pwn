...
//	if(GetPlayerAdminDutyStatus(playerid) == 1)
	...
	else if(Kajdanki_SkutyGracz[playerid] != INVALID_PLAYER_ID) //gdy skuwajπcy da /q
	{
	...
	if(IsPlayerConnected(playerid))
	{
		...
		if(GetPVarInt(playerid, "skip_bw")  == 0)
		{
			...
			else
			{
				...
				{
					//kajdanki
					if(Kajdanki_SkutyGracz[playerid] != INVALID_PLAYER_ID) //gdy skuwajπcy dostanie rannego
					{
						OdkujKajdanki(Kajdanki_SkutyGracz[playerid]);
					}
