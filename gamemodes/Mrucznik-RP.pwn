        ...
        for(new i=0;i<MAX_PATROLS;i++)
        {
            if(clickedid == PatrolMarker[i] && PatrolInfo[i][pataktywny] == 1)
            {
                ...
                switch(PatrolInfo[i][patstan])
                {
                    ...
                    case 5: stanp="Unikajcie danej lokalizacji";
                    case 6: stanp="Reagowanie poza pojazdem";
                    case 7: stanp="Przerwa w patrolu";
                    case 14: stanp="Powrót do normalnych czynności";
                }
