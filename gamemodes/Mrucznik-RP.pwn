	...
	if(GetPVarInt(playerid, "RozpoczalBieg") == 1)
	{
		if(GetPVarInt(playerid, "WybralBieg") == 1)
		{
			if(OszukujewBiegu[playerid] == 0)
			{
				...
				{
					CreateNewRunCheckPoint(playerid, 1709.3523,-1461.3938,13.5469, 3, "Zaliczy≥eú pierwszy przystanek, kolejny jest juø oznaczony!");
				}
				if(GetPVarInt(playerid, "ZaliczylBaze") == 1)
				{
					CreateNewRunCheckPoint(playerid, 1707.8762,-1584.3118,13.5453, 3, "Zaliczy≥eú drugi przystanek, kolejny jest juø oznaczony!"); 
				}
				...
				{
					CreateNewRunCheckPoint(playerid, 1538.9513,-1724.1267,13.5469, 3, "Zaliczy≥eú czwarty przystanek, kolejny jest juø oznaczony!"); 
				}
				if(GetPVarInt(playerid, "ZaliczylBaze") == 4)
				{
					CreateNewRunCheckPoint(playerid, 1322.6306,-1724.9469,13.5469, 3, "Zaliczy≥eú piπty przystanek, kolejny jest juø oznaczony!"); 
				}
				if(GetPVarInt(playerid, "ZaliczylBaze") == 5)
				{
					CreateNewRunCheckPoint(playerid, 1318.4052,-1841.7726,13.5469, 3, "Zaliczy≥eú szÛsty przystanek, kolejny jest juø oznaczony!"); 
				}
				if(GetPVarInt(playerid, "ZaliczylBaze") == 6)
				{
					CreateNewRunCheckPoint(playerid,  1382.2340,-1811.7761,13.5469, 3, "Zaliczy≥eú siÛdmy (przedostatni) przystanek, kolejny jest juø oznaczony!"); 
				}
		...
		else if(GetPVarInt(playerid, "WybralBieg") == 2)
		{
			if(GetPVarInt(playerid, "ZaliczylBaze") == 0)
			{
				CreateNewRunCheckPoint(playerid,  535.0668,-1364.9790,15.8432, 2, "Zaliczy≥eú pierwszy checkpoint! NastÍpny zosta≥ juø oznaczony"); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 1)
			{
				CreateNewRunCheckPoint(playerid,  339.2540,-1526.9476,33.3757, 2, "Zaliczy≥eú drugi checkpoint! NastÍpny zosta≥ oznaczony"); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 2)
			{
			...
			if(GetPVarInt(playerid, "ZaliczylBaze") == 3)
			{
				CreateNewRunCheckPoint(playerid,  364.1078,-1805.8809,7.8380, 2, "Zaliczy≥eú czwarty checkpoint! Piπty jest juø oznaczony!"); 
			}
			if(GetPVarInt(playerid, "ZaliczylBaze") == 4)
			{
			...
			if(GetPVarInt(playerid, "ZaliczylBaze") == 5)
			{
				CreateNewRunCheckPoint(playerid,  966.9481,-1834.9043,12.6000, 2, "SzÛsty przystanek zaliczony! Biegnij do kolejnego"); 
