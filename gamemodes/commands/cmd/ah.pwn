...
YCMD:ah(playerid, params[], help)
{
	...
	if (PlayerInfo[playerid][pNewAP] >= 1 && PlayerInfo[playerid][pNewAP] <= 3)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1-2-3* PÓ£ADMIN *** /zdejmijbpk /unbw /checkbw /paj /bp /setvw");
    }
	...
	if (PlayerInfo[playerid][pAdmin] >= 1)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1* ADMIN *** /zdejmijbpk /dajdowozu /tod /agraffiti /banip");
	}
