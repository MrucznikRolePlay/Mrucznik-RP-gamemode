...
YCMD:ah(playerid, params[], help)
{
	...
	if (PlayerInfo[playerid][pNewAP] >= 1 && PlayerInfo[playerid][pNewAP] <= 3)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1-2-3* PÓ£ADMIN *** /zdejmijbpk /unbw /checkbw /setvw /diagnoza /checktankmod");
    }
	if (PlayerInfo[playerid][pNewAP] == 4)
	{
		SendClientMessage(playerid, COLOR_GRAD1, "*4* PÓ£ADMIN *** /check /sban /sblock /goto /spec /a(dmin) chat");
		SendClientMessage(playerid, COLOR_GRAD1, "*4* PÓ£ADMIN *** /zdejmijbpk /checktankmod");
	}
    if (IsAScripter(playerid))
    {
        ...
        SendClientMessage(playerid, COLOR_GRAD1, "* SKRYPTER *** /gotomechy /gotobank /gotostacja /checktankmod");
	...
	if (PlayerInfo[playerid][pAdmin] >= 1)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1* ADMIN *** /check /pojazdygracza /sb /pokazcb /checktankmod");
