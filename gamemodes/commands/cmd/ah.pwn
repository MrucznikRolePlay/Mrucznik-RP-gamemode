...
YCMD:ah(playerid, params[], help)
{
	...
	if (PlayerInfo[playerid][pNewAP] >= 1 && PlayerInfo[playerid][pNewAP] <= 3)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1-2-3* PÓ£ADMIN *** /zdejmijbpk /unbw /checkbw");
    }
	...
	if (PlayerInfo[playerid][pAdmin] >= 1)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD1, "*1* ADMIN *** /zdejmijbpk /dajdowozu /banip");
	}
	if (PlayerInfo[playerid][pAdmin] >= 5)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD4,"*5* ADMIN *** /cca /ann /nonewbie /tod /gethere /checkdom /anulujzp");
	}
	...
	if (IsAHeadAdmin(playerid) || IsAScripter(playerid))
	{
		...
		SendClientMessage(playerid, COLOR_GRAD6,"*** 5000 *** /agraffiti /adajrange /antybh /bwsettings /bwtime /dajlicencje /glosowanie");
