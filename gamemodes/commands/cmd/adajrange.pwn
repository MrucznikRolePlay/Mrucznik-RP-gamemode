...
{
    if(IsAHeadAdmin(playerid) || IsAScripter(playerid) || Uprawnienia(playerid, ACCESS_MAKELEADER) || Uprawnienia(playerid, ACCESS_PANEL) || Uprawnienia(playerid, ACCESS_MAKEFAMILY))
    {
