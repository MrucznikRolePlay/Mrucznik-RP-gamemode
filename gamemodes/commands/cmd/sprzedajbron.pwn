...
YCMD:sprzedajbron(playerid, params[], help)
{
    ...
    if(IsPlayerConnected(playerid))
    {
        if(PlayerInfo[playerid][pJob] == 9)
        {
            ...
            {
                if(PlayerInfo[playerid][pConnectTime] >= 8)
                {
                ...
                {
                    SendClientMessage(playerid, COLOR_GRAD1, "* Broñ mog¹ posiadaæ tylko gracze z przegranymi minimum 8. godzinami online !");
                    SendClientMessage(giveplayerid, COLOR_GRAD1, "* Broñ mog¹ posiadaæ tylko gracze z przegranymi minimum 8. godzinami online !");
                    return 1;
                }
            }
            else
