...
YCMD:adminstats(playerid, params[], help)
{
	if(PlayerInfo[playerid][pAdmin] >= 1 )
	{
		...
		if(GetPlayerAdminDutyStatus(playerid) == 1)
		{
			...
			format(string, sizeof(string), "{C0C0C0}Statystyki\n{800080}Nick administratora:{C0C0C0}%s\n{800080}Nadane Bany: {C0C0C0}%d\n{800080}Nadane Warny: {C0C0C0}%d\n{800080}Nadane Kicki: {C0C0C0}%d\n{800080}Inne akcje: {C0C0C0}%d\n\n{C2A2DA}Na s³u¿bie ju¿: {C0C0C0}%d godzin i %d minut", GetNick(playerid),iloscBan[playerid],iloscWarn[playerid],iloscKick[playerid],(iloscInne[playerid]+iloscAJ[playerid]),AdminDutyGodziny[playerid], AdminDutyMinuty[playerid]);
