...
YCMD:pomoc2(playerid, params[], help)
{
    ...
    SendClientMessage(playerid,COLOR_GRAD5,"*** Przestêpcze *** /pobij /zwiaz /odwiaz /wepchnij /sprzedaja /maska-tak/nie");
    ...
    if (IsACop(playerid))
    {
        ...
        SendClientMessage(playerid, COLOR_GRAD5, "*** Policja *** /cela /togcrime /poscig /pozwolenie /finfo");
    }
