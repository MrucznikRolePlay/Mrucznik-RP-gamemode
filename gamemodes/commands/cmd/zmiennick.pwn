        ...
        if(PlayerInfo[playerid][pDom] == 0)
	    {
	        if(PlayerInfo[playerid][pPbiskey] == 255)
	        {
				...
				else
				{
                    ...
                    {
                    	SendClientMessageToAll(COLOR_LIGHTRED, sprintf("%s[%d] zmieni³ sobie nick - Nowy nick: %s", sendername,PlayerInfo[playerid][UID],params));
                    	Log(nickLog, INFO, "{Player: %s[%d]} zmieni³ nick na: %s", sendername, PlayerInfo[playerid][UID], params);
