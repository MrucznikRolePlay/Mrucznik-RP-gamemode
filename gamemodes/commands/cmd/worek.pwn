...
YCMD:worek(playerid, params[], help)
{
	...
	{ 
		sendTipMessageEx(playerid, COLOR_GREY, "Nie mo¿esz za³o¿yæ/œci¹gn¹æ sobie samemu worka!"); 
		return 1; 
	}
	...
	{	
		...
		SendClientMessage(giveplayerid, COLOR_LIGHTBLUE, string);
		format(string, sizeof(string), "* Za³o¿y³eœ %s worek na g³owê.", giveplayername);
		SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
