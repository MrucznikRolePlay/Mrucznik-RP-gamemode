...
{
	if(PlayerInfo[playerid][pRank] >= 6 && IsAClub(playerid) && IsPlayerInRangeOfPoint(playerid, 50.0, 1896.3619,-2445.5969,18.5559) && GetPlayerVirtualWorld(playerid) == 1) //RANGA
	{
