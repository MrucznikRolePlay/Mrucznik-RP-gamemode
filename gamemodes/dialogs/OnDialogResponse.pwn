...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	else if(dialogid == DIALOG_UNFRAKCJA)
	{
		...
		if(!response)
		{
			...
			Log(fracLDLog, INFO, "Admin %s usunπ≥ gracza %s z frakcji %s - pozostawiajπc VLD.", GetPlayerLogName(playerid), GetPlayerLogName(id_Lidera), GetFractionLogName(PlayerInfo[id_Lidera][pMember]));
