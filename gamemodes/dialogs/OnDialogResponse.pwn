			    ...
			    switch(listitem)
			    {
			        case 0:
			        {
						...
						else if(PlayerInfo[playerid][Rank] == 1)
						{
							...
							format(string, sizeof(string), "Urzπd Miasta Los Santos\n\n{0080FF}___Okienko %d___\n[%s: %s]\n{FF0000}[ID: %d]\n {00FFCC}Dowody Osobiste\n Karty WÍdkarskie\n Egzaminy Praktyczne i Teoretyczne\n Pozwolenia na broÒ", okienkoid+1,FracRang[11][PlayerInfo[playerid][Rank]],mojeimie,playerid);
							UpdateDynamic3DTextLabelText(okienko[okienkoid], 0xFFFFFFFF, string);
						}
						else if(PlayerInfo[playerid][Rank] == 2)
						{
							format(string, sizeof(string), "Urzπd Miasta Los Santos\n\n{0080FF}___Okienko %d___\n[%s: %s]\n{FF0000}[ID: %d]\n {00FFCC}Dowody Osobiste\n Karty WÍdkarskie\n Egzaminy Praktyczne i Teoretyczne\n Pozwolenia na broÒ\n Patenty Øeglarskie", okienkoid+1,FracRang[11][PlayerInfo[playerid][Rank]],mojeimie,playerid);
							UpdateDynamic3DTextLabelText(okienko[okienkoid], 0xFFFFFFFF, string);
						}
			        ...
			        case 2:
			        {
						format(string, sizeof(string), "Urzπd Miasta Los Santos\n\n{0080FF}___Okienko %d___\n[%s: %s]\n{FF0000}[ID: %d]\n {00FFCC} Egzaminy Teoretyczne\n{008080}Kaøde kolejne podejúcie\n wymaga zachowania 1h odstÍpu", okienkoid+1,FracRang[11][PlayerInfo[playerid][Rank]],mojeimie,playerid);
						UpdateDynamic3DTextLabelText(okienko[okienkoid], 0xFFFFFFFF, string);
			        }
			        case 3:
			        {
	    ...
	    else if(dialogid == 12)
	    {
	        if(response)
	        {
	            ...
	            switch(listitem)
	            {
					...
					case 19: //mroøony nietoperze z Wuhan
					{
						if(kaska[playerid] < 1500) 
						{
							sendErrorMessage(playerid, "Nie staÊ CiÍ na mroøonego nietoperza z Wuhan!");
							return 1;
						}
						if(Groceries[playerid][pWuhanBat] != 0)
						{
							sendErrorMessage(playerid, "Masz juø mroøonego nietoperza z Wuhan.");
							return 1;
						}
						Groceries[playerid][pWuhanBat] = random(650)+100;
						ZabierzKase(playerid, 1500);
						GameTextForPlayer(playerid, "~r~-$1500", 5000, 1);
						SendClientMessage(playerid, COLOR_GRAD4, "Kupi≥eú mroøonego nietoperza z Wuhan.");
					}
		    ...
		    if(response)
		    {
		        ...
		        if((strlen(inputtext) >= 1 && strlen(inputtext) <= 9) && kasa > 0 )
		        {
		            if(kasa <= Sejf_Rodziny[lider])
		            {
						...
						PlayerInfo[playerid][pBankMoney] += kasa;
 		...
 		if(dialogid == 7001)//wybiera≥ka GUI
	   	{
		   	if(response == 1)
		    {
			   	switch(listitem)
			   	{
				   	...
				   	{
						new skin = (PlayerInfo[playerid][pGender] == 2) ? 93 : 266;
					...
					{
						new skin = (PlayerInfo[playerid][pGender] == 2) ? 211 : 265;
						PlayerInfo[playerid][pSkin] = skin;
						SetPlayerSkinEx(playerid, skin);
						SendClientMessage(playerid, COLOR_LIGHTBLUE, "Zmieni≥eú swÛj uniform.");
					}
					...
					{	
						new skin = (PlayerInfo[playerid][pGender] == 2) ? 192 : 267;
						PlayerInfo[playerid][pSkin] = skin;
						SetPlayerSkinEx(playerid, skin);
						SendClientMessage(playerid, COLOR_LIGHTBLUE, "Zmieni≥eú swÛj uniform.");
					}
					...
					{	
						new skin = (PlayerInfo[playerid][pGender] == 2) ? 148 : 280;
						PlayerInfo[playerid][pSkin] = skin;
						SetPlayerSkinEx(playerid, skin);
						SendClientMessage(playerid, COLOR_LIGHTBLUE, "Zmieni≥eú swÛj uniform.");
					}
					...
					{	
						new skin = (PlayerInfo[playerid][pGender] == 2) ? 141 : 281;
						PlayerInfo[playerid][pSkin] = skin;
						SetPlayerSkinEx(playerid, skin);
						SendClientMessage(playerid, COLOR_LIGHTBLUE, "Zmieni≥eú swÛj uniform.");
					}
...
//----------------------------------
	...
	*/
	...
	if(dialogid==DIALOG_IBIZA_BILET)
	{
		...
		if(response)
		{
			//if(PlayerInfo[playerid][pBankMoney] < IbizaBilet) return SendClientMessage(playerid, -1, "Nie masz wystarczajπcej iloúci pieniÍdzy");
			...
			{
				//PlayerInfo[playerid][pBankMoney]-=IbizaBilet;
	...
	if(dialogid==DIALOG_IBIZA_BAR)
	{
		...
		if(response)
		{
			...
			if(hajs >=IbizaDrinkiCeny[drink]) //if(PlayerInfo[playerid][pBankMoney] >= IbizaDrinkiCeny[drink] )
			{
	...
	if(dialogid == D_MECH_SPRZEDAZ_FIXKIT)
	{
		...
		if(response)
		{
			...
			else
			{
				...
				SendClientMessage(playerid, 0x00FF00FF, sprintf("Kupi≥eú zestaw od mechanika %s za 15000$", GetNick(id)));
				ZabierzKase(playerid, 15000);
				DajKase(id, 15000);
...
//By Simeone 25-12-2018
	...
	else if(dialogid == 1067)
	{
		if(response)
        {
            ...
            switch(listitem)
            {
                ...
                case 0://Stan konta
				{
					format(string, sizeof(string), "{C0C0C0}Witaj {800080}%s{C0C0C0},\nObecny stan konta: {80FF00}%d$", giveplayer, PlayerInfo[playerid][pBankMoney]);
	...
	else if(dialogid == 1068)
	{
		if(response)
	    {
			if(gPlayerLogged[playerid] == 1)
			{
				...
				if(PlayerInfo[playerid][pBankMoney] + money > 2_000_000_000)
				{
				...
				new currentFunds = PlayerInfo[playerid][pBankMoney];
				...
				PlayerInfo[playerid][pBankMoney] = money + PlayerInfo[playerid][pBankMoney];
				format(string, sizeof(string), "  Depozyt: {80FF00}$%d", money);
				SendClientMessage(playerid, COLOR_GRAD4, string);
				SendClientMessage(playerid, COLOR_GRAD6, "|-----------------------------------------|");
				format(string, sizeof(string), "  Nowy stan: {80FF00}$%d", PlayerInfo[playerid][pBankMoney]);
				SendClientMessage(playerid, COLOR_WHITE, string);
	...
	else if(dialogid == 1071)//wyp≥ata z swojego konta
	{
		if(response)
	    {
			if(gPlayerLogged[playerid] == 1)
			{
				...
				if (money > PlayerInfo[playerid][pBankMoney] || money < 1)//Zabezpieczenie
				{
					sendTipMessage(playerid, "Nie masz tyle \\ B≥Ídna kwota");
					return 1;
				}
	...
	else if(dialogid == 1073)
	{
		...
		else//Jeúli kliknie "TAK"
		{
			...
			if(money >= 1 && money <= PlayerInfo[playerid][pBankMoney])//Zabezpieczenie 
			{
				if(PlayerInfo[giveplayerid][pBankMoney]+money > MAX_MONEY_IN_BANK)
				{
				...
				//Czynnoúci:
				PlayerInfo[playerid][pBankMoney] -= money;
				PlayerInfo[giveplayerid][pBankMoney] += money;
