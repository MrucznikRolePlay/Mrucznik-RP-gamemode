	            ...
	            switch(listitem)
	            {
					...
					case 15:
					{
						if (kaska[playerid] >= 35000 )
						{
							...
							GameTextForPlayer(playerid, string, 5000, 1);
							PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
							format(string, sizeof(string), "Kupi≥eú ogranicznik prÍdkoúci do auta.");
							SendClientMessage(playerid, COLOR_GRAD4, string);
							return 1;
						}
						else
					...
					case 16:
					{
						if (kaska[playerid] >= 30000 )
						{
							if(PlayerInfo[playerid][pFixKit] <= 5)
							{
								...
								GameTextForPlayer(playerid, string, 5000, 1);
								PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
								format(string, sizeof(string), "Kupi≥eú zestaw do naprawy aut!");
								SendClientMessage(playerid, COLOR_GRAD4, string);
								return 1;
							}
							else
							{
								SendClientMessage(playerid, COLOR_WHITE, "   Moøesz kupiÊ maksymalnie 5 zestawÛw!");
							}
						}
						else
						{
					...
					case 20: //mroøony nietoperze z Wuhan
					{
