...
//----[                                                                                                 ]----//
//----------------------------------------------------*------------------------------------------------------//
// Autor: mrN | oskryptowano by Sanda³
...
stock IbizaPanelCheck(){
	...
	format(txt_ibiza_VIPTicketCost, 128, "{FFFFFF}Bilet VIP: \t{00FF00}%d", ibizaVIPTicketCost);
...
stock IbizaTicketsCostCheck(){
	format(txt_ibiza_tickets, 128, "{FFFFFF}Rodzaj\tCena\nZwyk³y\t{00FF00}%d\n{FFFFFF}VIP\t{00FF00}%d", ibizaTicketCost, ibizaVIPTicketCost);
	return 1;
}