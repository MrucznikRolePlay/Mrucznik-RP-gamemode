...
ShowPlayerDamaged(playerid, forplayerid)
{
	...
	if(index != 0) 
	{
		for(new i = index-1; i>=0; i--)
		{
			...
			{
				case 0: format(weapon_decoded, sizeof(weapon_decoded), "%s", "PiÍúÊ");
				...
				case 4: format(weapon_decoded, sizeof(weapon_decoded), "%s", "NÛø");
				...
				case 17: format(weapon_decoded, sizeof(weapon_decoded), "%s", "Gaz ≥zawiπcy");
				...
				case 26: format(weapon_decoded, sizeof(weapon_decoded), "%s", "årÛtÛwka");
				...
				case 33: format(weapon_decoded, sizeof(weapon_decoded), "%s", "GwintÛwka");
				...
				case 42: format(weapon_decoded, sizeof(weapon_decoded), "%s", "Gaúnica");
