...
RemoveLeadersFromFraction(giveplayerid, playerid)//Usuwa liderÛw frakcji - giveplayerid to lider, playerid to osoba nadajπca
{
	...
	Log(adminLog, INFO, "Admin %s usunπ≥ gracza %s z frakcji %s - usuwajac VLD.", GetPlayerLogName(playerid), GetPlayerLogName(giveplayerid), GetFractionLogName(PlayerInfo[giveplayerid][pMember]));
