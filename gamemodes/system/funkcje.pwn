...
ShowStats(playerid,targetid)
{
    if(IsPlayerConnected(playerid) && IsPlayerConnected(targetid))
	{
		...
		new atext[20];
		if(PlayerInfo[targetid][Gender] == 1) { atext = "MÍøczyzna"; }
	...
	else
	{
	    ...
	    if(platnosc == 2)
		{
		    if(PlayerInfo[playerid][BankMoney] >= cenadomu && cenadomu != 0 && cenadomu > 0 && PlayerInfo[playerid][BankMoney] != 0 && PlayerInfo[playerid][BankMoney] > 0)
	        {
				...
				format(str2, sizeof(str2), "Gratulacje! Kupi≥eú dom za %d$. Zosta≥o one odliczone od twojego konta bankowego ktÛre wynosi teraz %d", cenadomu, PlayerInfo[playerid][BankMoney]);
