...
Oil_Destroy(lID)
{
    ...
    foreach(new i : Player)
    {
        ...
        DajKase(i, 7500);
        SendFamilyMessage(17, COLOR_GREEN, "[ERS] Straøak usunπ≥ plamÍ oleju! Na konto frakcji wp≥ywa 12 500$! [ERS]");
...
{
	SendClientMessage(forplayerid, COLOR_WHITE, sprintf("--- Ostatnie wiadomoúci gracza %s: ---", GetNick(forplayerid)));
