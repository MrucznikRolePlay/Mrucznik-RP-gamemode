...
public AktywujPozar()
{
	...
	if(losowy == 1)
	{
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: DOM JEDNORODZINNY - IDLEWOOD");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH KUCHENKI GAZOWEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
   		SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 2)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: SKLEP 24/7 W OKOLICACH DMV");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: AWARIA INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK SKLEPU");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 3)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: PIZZERIA IDLEWOOD");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: AWARIA KUCHENKI GAZOWEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK RESTAURACJI");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 4)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: SKLEP BINCO - GANTON");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 5)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: STACJA PALIW - TEMPLE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH DYSTRYBUTORA");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK STACJI");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 6)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: KONTENERY - LOSTNISKO LOS SANTOS");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: OCHRONA LOTNISKA");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 7)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: P¥CZKARNIA NA MARKET");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 8)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: BAR W DILLIMORE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 9)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: URZ¥D MIASTA PALOMINO CREEK");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK URZÊDU MIASTA");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 10)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: SKLEP 24/7 - IDLEWOOD");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 11)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: MOTEL JEFFERSON");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 12)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: SALON AUT");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 13)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: GUNSHOP OBOK BAZY LSFD");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: PODPALENIE");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRACOWNIK");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 14)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: BUDYNEK OBOK BIUROWCA FBI");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
	...
	else if(losowy == 15)
	{
		SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "           UWAGA: WYBUCH£ PO¯AR!");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "MIEJSCE PO¯ARU: BUDYNEK OBOK VINYL CLUB");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "PRZYCZYNA PO¯ARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "ZG£OSI£: PRZECHODZIEÑ");
    	SendFamilyMessage(FRAC_LSMC, 0xAA3333AA, "         !!!!UDAJ SIÊ NA MIEJSCE!!!!");
    	SendFamilyMessage(FRAC_LSMC, 0xFFFFFFAA, fraction_name);
