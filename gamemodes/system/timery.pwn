...
public EfektNarkotyku(playerid)
{
	...
	if(efektNarkotykuMinuta[playerid] == TIME_OF_DRUG_ACTIVITY)
	{
		...
		sendTipMessage(playerid, "WartoúÊ twojej si≥y wrÛci≥a do normy"); 
