...
new timeFakeVehRespawn[MAX_PLAYERS] = {0, ...}; // czas (tick) kiedy gracz ostatnio utopi� pojazd (albo udawa�, �e go utopi�, by je zrespawnowa�)
new countFakeVehRespawn[MAX_PLAYERS] = {0, ...}; // ile razy w ci�gu ostatnich 20 minut gracz utopi� pojazd (albo udawa�, �e go utopi�, by je zrespawnowa�)
new unoccupiedVehToCheckAC[MAX_VEHICLES] = {false, ...}; // true je�eli w przeci�gu ostatnich 3 sekund pozycja danego pojazdu zosta�a zmieniona przez synchronizacj� pojazdu bez kierowcy (UnoccupiedSync)
...
new unoccupiedVehBlockAC[MAX_PLAYERS] = {false, ...}; // true je�eli na gracza zosta�a za�o�ona blokada synchronizacji pojazd�w bez kierowcy
new performUnoccupiedVehCheckAC = false; // true je�eli pozycja kt�regokolwiek pojazdu zosta�a zmieniona w przeci�gu ostatnich 3 sekund przez synchronizacj� typu UnoccupiedSync
...
//Basen Tsunami
new poolStatus = 1;// 0 = zamkni�ty; 1 = otwarty;
...
//23.06 fina�
new KTAir_Start, KTAir_End, Float:KTAir_Offsets[3]; //Dla At400 nie rusza�.
...
{
	OfferPlayer[playerid] = -1;//Prawnik oferuje /uwolnij (Check)
	SN_ACCESS[playerid] = 0;//Pozwolenie na scen� (pob�r op�at - 2kk)
