...
PlayerTalkIC(playerid, text[], jakMowi[], Float:rangeTalk,  bool:chatBooble=true)
{
	...
	if(GetPlayerAdminDutyStatus(playerid) == 1)
	{
		if(strlen(text) < 78)
		{
			...
			if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "{FF6A6A}@ %s {C0C0C0}[%d] Czat OOC: (( %s ))", GetNick(playerid), playerid, text);
		...
		else
		{
			...
			if(pos != -1)
			{
				...
				if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "{C0C0C0}>>(([..] %s ))", text2);
	...
	if(strlen(text) < 78)
	{
		...
		if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "%s %s: %s", GetNick(playerid, true), jakMowi, text);
	...
	else
	{
		...
		if(pos != -1)
		{
			...
			format(string, sizeof(string), "%s %s: %s [.]", GetNick(playerid, true), jakMowi, text);
			ProxDetector(rangeTalk, playerid, CorrectICForm(string), COLOR_FADE1, COLOR_FADE2, COLOR_FADE3, COLOR_FADE4, COLOR_FADE5);
			if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "[.] %s", text2);
	...
	if(chatBooble == true)
	{
		if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "%s: %s", jakMowi, text);
...
PlayerTalkOOC(playerid, text[], Float:rangeTalk)
{
	...
	if(IsPlayerConnected(playerid))
	{
		...
		if(strlen(text) < 78)
        {
            if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "%s [%d] Czat OOC: (( %s ))", GetNick(playerid), playerid, text);
	    ...
	    if(strfind(text[ostatnialitera], ".", true, 0)  != -1 || strfind(text[ostatnialitera], "?", true, 0)  != -1 || strfind(text[ostatnialitera], "!", true, 0 || strfind(text[ostatnialitera], ":", true, 0)  != -1)  != -1 || strfind(text[ostatnialitera], "*", true, 0)) format(string, sizeof(string), "(( %s Napisa³: %s ))", GetNick(playerid), text);
