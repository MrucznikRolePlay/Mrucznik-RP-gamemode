//obiekty.pwn
// KOLEJNO��: rX,rY,rZ,VirtualWorld,Interior);
...
DeleteObjects(playerid)
{
    ...
    //___Obiekty usuni�te - Osiedle Idlewood/Alhambra___
...
{	
	...
	//obiekty DMV (wystr�j zewn�trzny)
	...
	//obiekty DMV wystr�j zewn�trzny - znaki drogowe (by Dywan)
	...
	CreateDynamicObject(3109,2119.1999512,-2275.6000977,20.8999996,0.0000000,0.0000000,44.0000000); //object(imy_la_door) (1) drzwi blokuj�ce skr�t
	...
	//Biurowiec prawnik�w i �owc�w nagr�d
	...
	//obiekty cywilne przystanek BAZA MECHANIK�W (p�tla)
	...
	//SetDynamicObjectMaterialText(BMpetla, "Baza Mechanik�w (p�tla)", 0, OBJECT_MATERIAL_SIZE_256x128,"Arial", 28, 1, 0xFFFFFFFF, 0, OBJECT_MATERIAL_TEXT_ALIGN_CENTER);
	//SetDynamicObjectMaterialText(,0,"{000000}Przystanek\nBaza Mechanik�w (p�tla)\nKursuje linia: 72",28,"Ariel",30,0,0xFFFFFFFF,0x000000FF,0);
	...
	CreateDynamicObject(14467,2792.3999023,-1535.8000488,12.8000002,0.0000000,0.0000000,50.0000000,0,0); //kr�l mechanik�w
...
// obiekty cywilne (bar) int 19
	...
	//zajezdnia autobusowa commerce (+ wystr�j) obiekty cywilne
