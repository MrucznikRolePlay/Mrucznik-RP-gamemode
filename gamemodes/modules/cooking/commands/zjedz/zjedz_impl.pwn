    ...
    if(GetPlayerHealth(playerid, health) < 80)
    {
        ...
        switch (cookid)
        {
            case 1:
            {
                ...
                format(string, sizeof(string), "* Zjad³eœ %s wa¿¹c¹ %d, dosta³eœ wiêcej ¿ycia."[pCook][0][playerid][pCook1], hp);
            ...
            case 2:
            {
                ...
                ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
                format(string, sizeof(string), "* Zjad³eœ %s wa¿¹c¹ %d, dosta³eœ wiêcej ¿ycia."[pCook][1][playerid][pCook][1], hp);
                SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
            }
            case 3:
            {
                ...
                ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
                format(string, sizeof(string), "* Zjad³eœ %s o wadze %d, dosta³eœ wiêcej ¿ycia.",Cooki[pCook][2]rid][pCook][2], hp);
                SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
            }
            case 4:
            {
                ...
                ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
                format(string, sizeof(string), "* Zjad³eœ %s o wadze %d, dosta³eœ wiêcej ¿ycia.",Cooki[pCook][3]rid][pCook][3], hp);
                SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
            }
            case 5:
            {
                ...
                ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
                format(string, sizeof(string), "* Zjad³eœ %s o wadze %d, dosta³eœ wiêcej ¿ycia.",Cooki[pCook][4]rid][pCook][4], hp);
                SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
            }
        }
