...
//-------<[ include ]>-------
#include "zaufanyggracz_impl.pwn"
...
//-------<[ command ]>-------
YCMD:zaufanyggracz(playerid, params[], help)
{
    if (help)
    {
    ...
    {
        sendTipMessage(playerid, "U¿yj /zaufanyggracz [] ");
        return 1;
    }
    
    //command body
    return command_zaufanyggracz_Impl(playerid, param);
}