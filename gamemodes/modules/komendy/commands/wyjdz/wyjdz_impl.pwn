...
command_wyjdz_Impl(playerid)
{
    if(IsPlayerConnected(playerid))
	{
    	...
    	//wyjœcie bileterki
    	else if(IsPlayerInRangeOfPoint(playerid, 2.0, 397.6174,-1806.2030,7.8381) && IsFrontBusinnesOwnedByPlayerOrg(playerid, 39) && GetPlayerVirtualWorld(playerid) == 0) //RANGA
    	{
