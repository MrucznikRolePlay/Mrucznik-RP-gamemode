...
//------------------<[ Implementacja: ]>-------------------
command_wezzlecenie_Impl(playerid, params[256])
{
					            ...
					            if(PlayerToPoint(5.0,playerid,325.0463,306.9240,999.1484) || (PlayerToPoint(25.0,playerid,246.66,65.80,1003.64) && GetPlayerInterior(playerid) == 6))
					            {
						    		if(PlayerInfo[playerid][pDetSkill] <= 50)
						    		{
										if(PoziomPoszukiwania[playa] == 2 || PoziomPoszukiwania[playa] == 10)
						    			{
									        ...
									        format(string, sizeof(string), "Wziπ≥eú zlecenie na %s. Aby namierzyÊ jego pozycje wpisz /znajdz. Za martwego otrzymasz: %d$ Za øywego: %d$",giveplayer, deadReward, liveReward);
                                    ...
                                    else if(PlayerInfo[playerid][pDetSkill] > 50 && PlayerInfo[playerid][pDetSkill] < 100)
						    		{
                                        if(PoziomPoszukiwania[playa] >= 2 && PoziomPoszukiwania[playa] <= 3 || PoziomPoszukiwania[playa] == 10)
							    		{
                                            lowcaz[playerid] = playa;
						        			GetPlayerName(playa, giveplayer, sizeof(giveplayer));
									        format(string, sizeof(string), "Wziπ≥eú zlecenie na %s. Za martwego otrzymasz: %d$ Za øywego: %d$",giveplayer, deadReward, liveReward);
									        SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
							    		}
							    		else
						    			{
