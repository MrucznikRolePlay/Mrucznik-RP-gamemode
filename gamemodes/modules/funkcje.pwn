...
IsATechnik(playerid)//Funkcja stworzona na proúbÍ 0Verte (dla Simeone || dla PECET) 
//Uprawnia do uøycia: /zrobdom; /usundom; /domint; /gotobiz; /dajbiznes; /zabierzbiznes (do wydzia≥u planowania -daj i zabierz biz) /zapiszdomy; /zapiszkonta; /setwiek; /setchoroba;/dn;/sn; /rapidfly; /setskin (tylkosobie) 
