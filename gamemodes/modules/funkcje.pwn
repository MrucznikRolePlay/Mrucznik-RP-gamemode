...
stock Load3DText()
{
    CreateDynamic3DTextLabel("[FABRYKA MATERIA£”W BAY SIDE]\nUøyj: /mats wez", 0x1ebb14FF, 249.5962,-157.1357,1.5703+0.5, 10.0);
    CreateDynamicPickup(1279, 3, 249.5962,-157.1357,1.5703, -1, -1, -1, 30.0);
    CreateDynamic3DTextLabel("[GunShop Dillimore - dostawa]\nUøyj: /mats dostarcz", 0x1ebb14FF, 702.3633,-491.9083,16.3359+0.5, 10.0);
    CreateDynamic3DTextLabel("[GunShop Los Santos - dostawa]\nUøyj: /mats dostarcz", 0x1ebb14FF, 1796.3542,-1146.5486,23.8765+0.5, 10.0);
	return 1;
}
