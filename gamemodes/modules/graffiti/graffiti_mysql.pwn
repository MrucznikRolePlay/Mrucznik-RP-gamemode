...
stock graffiti_LoadMySQL(id = -1)
{
	...
	if(id == -1)
	{
		for(new i; i < GRAFFITI_MAX; i++) 
		{
			...
			GraffitiInfo[i][gID] = CreateDynamicObject(19482, GraffitiInfo[id][grafXpos], GraffitiInfo[id][grafYpos], GraffitiInfo[id][grafZpos], GraffitiInfo[id][grafXYpos], GraffitiInfo[id][grafYYpos], GraffitiInfo[id][grafZYpos], 0, 0, -1, 200);
