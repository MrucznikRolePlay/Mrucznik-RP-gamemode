...
CreateFakePayNSprayPickups()
{
    ...
    {
        FakePayNSprayPickups[i] = CreateDynamicPickup(1318, 1, 
        ...
        CreateDynamicMapIcon(FakePayNSpray[i][0], FakePayNSpray[i][1], FakePayNSpray[i][2], 63, -1, -1, -1, -1, -1, MAPICON_GLOBAL);
    }
}
