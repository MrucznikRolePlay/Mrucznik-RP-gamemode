...
ViceCityGates()
{
    ...
    DodajBrame(
        CreateDynamicObject(968, 209.142471, 180.683502, 1004.601684, 0.000000, 0.000000, 0.000000, 7110, 3),
        ...
        209.127639, 179.046417, 1004.591735, 0.000000, 0.000000, 0.000000, // closed
         1.0, 5.0, 1, 2);
    DodajBrame(
        CreateDynamicObject(968, 209.134201, 159.911682, 1004.583679, 0.000000, 0.000000, 0.000000, 7110, 3), 
    ...
    // NG base gate
    DodajBrame(
        CreateDynamicObject(968, -5922.489257, 1957.911376, 9.327517, 0.000000, 0.370376, -0.009465, 0, 0),
