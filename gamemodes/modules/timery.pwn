		...
		if(PlayerInfo[i][pJailed] > 0)
		{
			...
			if(PlayerInfo[i][pJailTime] <= 0 && WantLawyer[i] == 0)
			{
				...
				else if(PlayerInfo[i][pJailed] == 3)
				{
					...
					{
						format(string, sizeof(string), "[Marcepan Marks] Zabra≥em graczu %s broÒ [Odsiedzia≥ karÍ za DM2]" GetNick(playerid, true));
						SendAdminMessage(COLOR_PANICRED, string);
						format(string, sizeof(string), "%s zabra≥em twojπ broÒ. Z pozdrowieniami - Marcepan Marks", GetNick(playerid, true));
