...
public AntiSpamMute(playerid)
{
    ...
    MruDialog(playerid, "ACv2: Kod #2006", "Minπ≥ czas wyciszenia. Nie spamuj!");
}
...
public CheckCode2003(killerid, playerid)
{
	...
	{
    	MruDialog(killerid, "ACv2: Kod #2003", "Zosta≥eú wyrzucony za weapon hack.");
	...
	{
	    format(string, sizeof string, "ACv2 [#2003] WARNING: Prawdopodobnie prÛba wymuszenia kodu na graczu %s.", GetNick(killerid, true));
    	SendCommandLogMessage(string);
	}
}
...
public SpecToggle(playerid)
{
    ...
    sendTipMessage(playerid, "Wczytywanie obiektÛw!");
}
...
public SprzedajMatsTimer(playerid,giveplayerid)
{
	if(GetPVarInt(giveplayerid, "OKupMats") == 1)
	{
    	...
    	sendErrorMessage(giveplayerid, "Sprzedaø mats zosta≥a anulowana!");
	}
	if(GetPVarInt(playerid, "OSprzedajMats") == 1)
	{
		SetPVarInt(playerid, "OSprzedajMats", 0);
		sendErrorMessage(playerid, "Sprzedaø mats zosta≥a anulowana!");
	}
	return 1;
}
//PizzaJob
public PizzaJobTimer01(playerid)
{
	if(PizzaJob[playerid] == 1)
	{
		...
		DajKase(playerid, 1000);
	 	...
	 	format(string, sizeof(string), "Dostarczy≥eú pizzÍ! Otrzyma≥eú $1000 za przewiezienie pizzy pod wskazany adres i $%d napiwku!.", napiwek);
		SendClientMessage(playerid, COLOR_GREEN, string);
		SendClientMessage(playerid, COLOR_WHITE, "Klient Janusz_Mechanik mÛwi: Trzymaj napiwek! Pizza jeszcze cieplutka i pachnπca!");
...
public Naprawa(playerid)
{
	if(IsPlayerInAnyVehicle(playerid))
	{
		...
		format(string, sizeof(string), "* TwÛj samochÛd zosta≥ naprawiony za $%d przez mechanika %s.",RepairPrice[playerid],giveplayer);
		SendClientMessage(playerid, COLOR_LIGHTBLUE, string);
		format(string, sizeof(string), "* Naprawi≥eú pojazd %s, otrzymujesz $%d.",giveplayer,RepairPrice[playerid]);
		SendClientMessage(RepairOffer[playerid], COLOR_LIGHTBLUE, string);
		format(string, sizeof(string),"* Mechanik %s naprawia pojazd %s i chowa narzÍdzia do skrzynki.",giveplayer,VehicleNames[GetVehicleModel(RepairCar[playerid])-400]);
		ProxDetector(20.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
		format(string, sizeof(string), "* Silnik pojazdu znÛw dzia≥a jak naleøy (( %s ))", giveplayer);
		ProxDetector(20.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
		PlayerInfo[RepairOffer[playerid]][pMechSkill] ++;
		if(PlayerInfo[RepairOffer[playerid]][pMechSkill] == 50)
		{ SendClientMessage(RepairOffer[playerid], COLOR_YELLOW, "* Twoje umiejÍtnoúci Mechanika wynoszπ 2, Moøesz teraz tankowaÊ graczom wiÍcej paliwa za jednym razem."); }
		else if(PlayerInfo[RepairOffer[playerid]][pMechSkill] == 100)
		{ SendClientMessage(RepairOffer[playerid], COLOR_YELLOW, "* Twoje umiejÍtnoúci Mechanika wynoszπ 3, Moøesz teraz tankowaÊ graczom wiÍcej paliwa za jednym razem."); }
		else if(PlayerInfo[RepairOffer[playerid]][pMechSkill] == 200)
		{ SendClientMessage(RepairOffer[playerid], COLOR_YELLOW, "* Twoje umiejÍtnoúci Mechanika wynoszπ 4, Moøesz teraz tankowaÊ graczom wiÍcej paliwa za jednym razem."); }
		else if(PlayerInfo[RepairOffer[playerid]][pMechSkill] == 400)
		{ SendClientMessage(RepairOffer[playerid], COLOR_YELLOW, "* Twoje umiejÍtnoúci Mechanika wynoszπ 5, Moøesz teraz tankowaÊ graczom wiÍcej paliwa za jednym razem."); }
	...
	{
		SendClientMessage(playerid, -1, "Naprawa przerwana - wyszed≥eú z pojazdu");
	}
    return 1;
}
...
public AktywujPozar()
{
    ...
    new losowy = random(16);
	if(losowy == 1)
	{
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: DOM JEDNORODZINNY - IDLEWOOD");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH KUCHENKI GAZOWEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
	...
	else if(losowy == 2)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: SKLEP 24/7 W OKOLICACH DMV");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: AWARIA INSTALACJI ELEKTRYCZNEJ");
	...
	else if(losowy == 3)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: PIZZERIA IDLEWOOD");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: AWARIA KUCHENKI GAZOWEJ");
	...
	else if(losowy == 4)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: SKLEP BINCO - GANTON");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 5)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: STACJA PALIW - TEMPLE");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH DYSTRYBUTORA");
	...
	else if(losowy == 6)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: KONTENERY - LOSTNISKO LOS SANTOS");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: OCHRONA LOTNISKA");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	ABroadCast(COLOR_YELLOW,"[SYSTEM POØAR”W] Aktywowano poøar: KONTENERY - LOSTNISKO LOS SANTOS",1);
	...
	else if(losowy == 7)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: P•CZKARNIA NA MARKET");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 8)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: BAR W DILLIMORE");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 9)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: URZ•D MIASTA PALOMINO CREEK");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRACOWNIK URZ DU MIASTA");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 10)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: SKLEP 24/7 - IDLEWOOD");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 11)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: MOTEL JEFFERSON");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 12)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: SALON AUT");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
	...
	else if(losowy == 13)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: GUNSHOP OBOK BAZY LSFD");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRACOWNIK");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 14)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: BUDYNEK OBOK BIUROWCA FBI");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 15)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: BUDYNEK OBOK VINYL CLUB");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
	...
	else if(losowy == 16)
	{
		SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	SendFamilyMessage(17, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(17, 0xAA3333AA, "MIEJSCE POØARU: MAGAZYN W BLUEBERRY");
    	SendFamilyMessage(17, 0xAA3333AA, "PRZYCZYNA POØARU: AWARIA INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(17, 0xAA3333AA, "ZG£OSI£: W£AåCICIEL MAGAZYNU");
    	SendFamilyMessage(17, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(17, 0xFFFFFFAA, "--------[LOS SANTOS FIRE DEPARTMENT]--------");
    	ABroadCast(COLOR_YELLOW,"[SYSTEM POØAR”W] Aktywowano poøar: MAGAZYN W BLUEBERRY",1);
    	AddFire(95.840431, -160.426895, 3.158843, 400);
		AddFire(95.840431, -159.036895, 3.158843, 400);
		AddFire(95.840431, -157.816894, 3.158843, 400);
		AddFire(93.760452, -157.796844, 3.158843, 400);
		AddFire(92.050430, -157.716903, 3.158843, 400);
		AddFire(89.970436, -157.706909, 3.158843, 400);
		AddFire(89.970436, -158.686920, 3.158843, 400);
		AddFire(89.970436, -160.706924, 3.158843, 400);
		AddFire(94.857772, -167.666503, 4.976511, 400);
		AddFire(95.897773, -167.666503, 4.976511, 400);
		AddFire(96.887779, -167.666503, 4.976511, 400);
		AddFire(89.147796, -167.666503, 4.976511, 400);
		AddFire(88.007797, -167.666503, 4.976511, 400);
		AddFire(87.017807, -167.666503, 4.976511, 400);
		AddFire(87.017807, -162.866455, 4.976511, 400);
		AddFire(88.117767, -162.866455, 5.046511, 400);
		AddFire(88.927764, -162.866455, 5.046511, 400);
		AddFire(95.437789, -162.866455, 5.046511, 400);
		AddFire(95.857795, -162.866455, 5.046511, 400);
		AddFire(97.117813, -162.866455, 5.046511, 400);
		AddFire(100.287788, -162.866455, 0.496511, 400);
		AddFire(100.287788, -161.736480, 0.496511, 400);
		AddFire(100.287788, -167.626449, 0.496511, 400);
		AddFire(100.287788, -168.546417, 0.496511, 400);
		AddFire(100.287788, -168.546417, 4.506511, 400);
		AddFire(100.287788, -167.686462, 4.966511, 400);
		AddFire(100.287788, -166.306457, 5.266513, 400);
		AddFire(100.287788, -165.136474, 5.266513, 400);
		AddFire(100.287788, -163.956497, 5.266513, 400);
		AddFire(100.287788, -162.826507, 5.026513, 400);
		AddFire(100.287788, -161.596481, 4.736510, 400);
		AddFire(100.287788, -164.056472, 0.176510, 400);
		AddFire(100.287788, -165.166473, 0.176510, 400);
		AddFire(100.287788, -166.476470, 0.176510, 400);
		AddFire(100.287788, -166.946441, 3.286510, 400);
		AddFire(100.287788, -165.776458, 3.286510, 400);
		AddFire(100.287788, -164.426498, 3.286510, 400);
		AddFire(100.287788, -163.626510, 3.286510, 400);
		AddFire(98.417800, -160.926620, 1.676511, 400);
		AddFire(98.417800, -160.926620, 0.336512, 400);
		AddFire(89.007766, -160.926620, 0.336512, 400);
		AddFire(87.927757, -160.926620, 0.336512, 400);
		AddFire(87.927757, -160.926620, 0.336512, 400);
		AddFire(86.637756, -160.926620, 0.336512, 400);
		AddFire(85.197731, -160.926620, 0.336512, 400);
		AddFire(85.197731, -160.926620, 2.866511, 400);
		AddFire(86.497726, -160.926620, 2.866511, 400);
		AddFire(87.347732, -160.926620, 2.866511, 400);
		AddFire(88.757743, -160.926620, 2.866511, 400);
		AddFire(84.237731, -167.326675, 2.866511, 400);
		AddFire(84.237731, -165.556701, 2.866511, 400);
		AddFire(84.237731, -164.326660, 2.866511, 400);
		AddFire(84.237731, -162.946640, 2.866511, 400);
	}
    return 1;
}
...
public PlayerAFK(playerid, afktime, breaktime)
{
	if(IsPlayerPaused(playerid))
	{
		...
		if(afktime > 600 && PlayerInfo[playerid][pAdmin] >= 1 ||afktime > 600 && PlayerInfo[playerid][pNewAP] >= 1)
		{
			...
			{
				SendClientMessage(playerid, 0xAA3333AA, "Zosta≥eú skickowany za zbyt d≥ugie AFK (30 minut).");
		...
		else if(afktime > 600 && PlayerInfo[playerid][pDonateRank] >= 1)
		{
			if(afktime > 1200)
			{
				SendClientMessage(playerid, 0xAA3333AA, "Zosta≥eú skickowany za zbyt d≥ugie AFK (20 minut).");
				SetTimerEx("KickEx", 500, false, "i", playerid);
			}
			SetPlayerChatBubble(playerid, caption, 0x33AA33AA, 20.0, 1500);
		}
		...
		{
			SendClientMessage(playerid, 0xAA3333AA, "Zosta≥eú skickowany za zbyt d≥ugie AFK (10 minut).");
			SetTimerEx("KickEx", 500, false, "i", playerid);
		}
		else
		{
	...
	foreach(Player, i)
	{
		...
		if(GetPlayerPing(i) >= 2000 && PlayerInfo[i][pAdmin] == 0)
		{
			if(gPlayerLogged[i] == 1)
			{
				...
				{
					SendClientMessage(i, COLOR_PANICRED, "Dosta≥eú kicka, POW”D: Ping wiÍkszy niø 2 000");
					KickEx(i);
				}
			}
		}
		...
		if(gPlayerLogged[i] == 1 || TutTime[i] >= 1)
		{
			if(playerState >= 1 && playerState <= 6)
			{
				...
				if(ac_val)
				{
					...
					{
						format(string, sizeof(string), "Dosta≥eú kicka od systemu, powÛd: Spawn Broni [%d]", ac_val);
                    ...
                    switch(weaponID)
                    {
                        ...
                        case 4://nÛø
    					{
    						if(PlayerInfo[i][pGun1] != 4 && PlayerInfo[i][pMember] != 8 && PlayerInfo[i][pLider] != 8)
    						{
                                ...
                                {
        							SendClientMessage(i, COLOR_PANICRED, "Dosta≥eú kicka od systemu, powÛd: Spawn Broni");
        							KickEx(i);
                                }
    						}
    					}
			...
			if(gPlayerLogged[i] == 1 || TutTime[i] >= 1)
			{
				if(playerState == 1 || playerState == 2 || playerState == 3)
				{
                    ...
                    switch(weaponID)
                    {
    					case 0:
    					{
    						format(string, sizeof(string), "* %s chowa BroÒ.", specNAME);
    					...
    					case 2:
    					{
    						format(string, sizeof(string), "* %swyciπga Kij Golfowy.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 3:
    					{
    						format(string, sizeof(string), "* %s wyciπga Pa≥kÍ Policyjnπ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 4:
    					{
    						format(string, sizeof(string), "* %s wyciπga NÛø.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 5:
    					{
    						format(string, sizeof(string), "* %s wyciπga Bejzbol.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 6:
    					{
    						format(string, sizeof(string), "* %s wyciπga £opatÍ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 7:
    					{
    						format(string, sizeof(string), "* %s wyciπga Kij Bilardowy.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 8:
    					{
    						format(string, sizeof(string), "* %s wyciπga Katane.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 9:
    					{
    						format(string, sizeof(string), "* %s wyciπga Pi≥Í Mechanicznπ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 14:
    					{
    						format(string, sizeof(string), "* %s wyciπga Kwiaty.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 15:
    					{
    						format(string, sizeof(string), "* %s wyciπga DÍbowπ LaskÍ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 16:
    					{
    						format(string, sizeof(string), "* %s wyciπga Granat.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 17:
    					{
    						format(string, sizeof(string), "* %s wyciπga Gaz £zawiπcy.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 18:
    					{
    						format(string, sizeof(string), "* %s wyciπga Koktajl Mo≥otova.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}
    					...
    					case 22:
    					{
    						format(string, sizeof(string), "* %s wyciπga z kieszeni Pistolety 9mm.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 23:
    					{
    						format(string, sizeof(string), "* %s wyciπga Pistolet z T≥umikiem.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 24:
    					{
    						format(string, sizeof(string), "* %s wyciπga Pistolet Deagle.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 25:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli Shotgun'a.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 26:
    					{
    						format(string, sizeof(string), "* %s wyciπga z rzeüni Obrzyny.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 27:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli Spas-12.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 28:
    					{
    						format(string, sizeof(string), "* %s wyciπga z kabury UZI.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 29:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli MP5.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 30:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli AK47.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 31:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli M4.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 32:
    					{
    						format(string, sizeof(string), "* %s wyciπga z kabury TEC-9.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 33:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli StrzelbÍ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 34:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza koszuli SnajperkÍ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 35:
    					{
    						format(string, sizeof(string), "* %s wyciπga zza ucha RPG.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}
    					...
    					case 37:
    					{
    						format(string, sizeof(string), "* %s wyciπga z ognia Miotacz Ognia.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}
    					...
    					case 39:
    					{
    						format(string, sizeof(string), "* %s wyciπga z torby C4.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 40:
    					{
    						format(string, sizeof(string), "* %s wyciπga detonator.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 41:
    					{
    						format(string, sizeof(string), "* %s wyciπga Gaz Pieprzowy / Spray.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 42:
    					{
    						format(string, sizeof(string), "* %s wyciπga GaúnicÍ.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 43:
    					{
    						format(string, sizeof(string), "* %s wyciπga Aparat Fotograficzny.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}

    					case 44:
    					{
    						format(string, sizeof(string), "* %s wyciπga noktowizor", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    						ResetPlayerWeapons(i);
    					}
    					...
    					case 45:
    					{
    						format(string, sizeof(string), "* %s wyciπga termowizor.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    						ResetPlayerWeapons(i);
    					}
					...
					if(weaponID >= 22 && weaponID <= 38)
					{
                        ...
                        {
							format(string, sizeof(string), "* %s wy≥πcza i chowa paralizator do kabury.", specNAME);
			...
			if(OrderReady[i] > 0)
			{
				switch (OrderReady[i])
				{
				    case 1:
					{
						...
						SendClientMessage(i, COLOR_LIGHTBLUE, "* Zabra≥eú zamÛwiony towar.");
					}
					case 2:
					{
...
public RPGTimer()
{
	foreach(Player, i)
	{
        ...
        {
			MruDialog(i, "ACv2: Kod #2005", "Zosta≥eú wyrzucony za weapon hack RPG.");
    ...
    foreach(Player, i)
	{
		...
		if(RingTone[i] > 0 && Mobile[i] >= 0)
		{
			...
			else
			{
				...
				if(RingTone[i]%12 == 0 || RingTone[i] == 1)
				{
					...
					if(slotKontaktu >= 0)
					{
						format(string, sizeof(string), "TwÛj telefon dzwoni, (aby odebraÊ wpisz: /p) dzwoniπcy: %s (%d)", Kontakty[i][slotKontaktu][eNazwa], PlayerInfo[caller][pPnumber]);
					}
					else
					{
						format(string, sizeof(string), "TwÛj telefon dzwoni, (aby odebraÊ wpisz: /p) dzwoniπcy: %d", PlayerInfo[caller][pPnumber]);
					}
					SendClientMessage(i, COLOR_YELLOW, string);
					format(string, sizeof(string), "* Telefon %s zaczyna dzwoniÊ.", GetNick(i));
					ProxDetector(30.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
					PlayerPlaySound(i, 23000, 0.0, 0.0, 0.0);
				}
				RingTone[i]++;
		...
		if(PlayerInfo[i][pJailed] > 0)
		{
			...
			if(PlayerInfo[i][pJailTime] <= 0 && WantLawyer[i] == 0)
			{
				...
				PlayerInfo[i][pJailed] = 0;
				SendClientMessage(i, COLOR_GRAD1,"   WolnoúÊ! Odsiedzia≥eú karÍ, mamy nadzieje øe to ciÍ czegoú nauczy≥o.");
		...
		if(State == PLAYER_STATE_DRIVER)
		{
			if(IsPlayerInRangeOfPoint(i, 7.0, 2064.0703,-1831.3167,13.3853) || IsPlayerInRangeOfPoint(i, 7.0, 1024.8514,-1022.2302,31.9395) || IsPlayerInRangeOfPoint(i, 7.0, 486.9398,-1742.4130,10.9594) || IsPlayerInRangeOfPoint(i, 7.0, -1904.2325,285.3743,40.8843)  || IsPlayerInRangeOfPoint(i, 7.0, 720.0876,-458.3574,16.3359))
			{
				if(naprawiony[i] == 0)
				{
					...
					if(health <= 999)
					{
				        sendTipMessageFormat(i, "Zap≥aci≥eú $%d za wizytÍ w warsztacie", 7500);
				        ZabierzKase(i, 7500);
        ...
        {
        	SetPlayerArmedWeapon(i, 0);
        	MruDialog(i, "Informacja", "Niedawno zosta≥es obezw≥adniony, nie moøesz korzystaÊ z broni przez pewien czas!");
        }*/
		...
		if(MedicTime[i] > 0)
		{
			...
			{
				format(string, sizeof(string), "DOKTOR: %d zosta≥eú uleczony.", i);
		...
		if(WantLawyer[i] >= 1)
		{
			...
			if(WantLawyer[i] >= 20)
			{
				SendClientMessage(i, COLOR_LIGHTRED, "Nie moøesz juø wezwaÊ prawnika, Czas odsiadki rozpoczÍty.");
				WantLawyer[i] = 0;
				CallLawyer[i] = 0;
			}
		}
		if(TutTime[i] >= 1 && !IsPlayerNPC(i))
		{
			...
			if(TutTime[i] == 3)
			{
				...
				SendClientMessage(i, COLOR_PURPLE, "|____ Tutorial: Poczπtek ____|");
				SendClientMessage(i, COLOR_WHITE, "Ooo... nowy na serwerze.... wiÍc musisz o czymú wiedzieÊ.");
				SendClientMessage(i, COLOR_WHITE, "Jest to serwer Role Play(RP). Role Playing to odzwierciedlanie realnego øycia w grze.");
				SendClientMessage(i, COLOR_WHITE, "Skoro juø wiesz, co to jest Role Play musisz poznaÊ zasady serwera.");
			}
			...
			{
				SendClientMessage(i, COLOR_WHITE, "Na serwerze obowiπzuje absolutny zakaz jakiegokolwiek DeathMatch`u(DM).");
				SendClientMessage(i, COLOR_WHITE, "Nie chcemy na serwerze osÛb ktÛre bezmyúlnie zabijajπ wszystko co siÍ rusza.");
				SendClientMessage(i, COLOR_WHITE, "Chodzi o to, øe w prawdziwym øyciu, nie zabija≥byú wszystkich dooko≥a.");
				SendClientMessage(i, COLOR_WHITE, "WiÍc jeúli chcesz kogoú zabiÊ, musisz mieÊ naprawdÍ waøny powÛd.");
				SendClientMessage(i, COLOR_WHITE, "Na serwerze trzeba mieÊ nick typu Imie_Nazwisko (np. Jan_Kowalski)");
				SendClientMessage(i, COLOR_WHITE, "Jeúli masz inny nick niø Imie_Nazwisko to poproú admina o zmianÍ go.");
			}
			...
			{
				SendClientMessage(i, COLOR_WHITE, "Jeøeli widzisz, øe ktoú cheatuje, powiadom administratorÛw przez komendÍ /report.");
				SendClientMessage(i, COLOR_WHITE, "Nie wolno uøywaÊ BugÛw (np. znasz jakiegoú buga ktÛry daje ci kase).");
				SendClientMessage(i, COLOR_WHITE, "Jeúli masz czity, wy≥πcz je i idü na jakiú inny serwer. Tu nie moøna czitowaÊ.");
				SendClientMessage(i, COLOR_WHITE, "Osoba korzystajπca z CheatÛw i BugÛw moøe zostaÊ zbanowana lub ostrzeøona.");
			}
			...
			{
				SendClientMessage(i, COLOR_WHITE, "A wiÍc musisz wiedzieÊ co to jest OOC i IC, oraz poprawnie to interpretowaÊ.");
				SendClientMessage(i, COLOR_WHITE, "Ta zasada jest bardzo waøna, wiÍc czytaj uwaønie, oraz zapamiÍtaj to.");
				SendClientMessage(i, COLOR_WHITE, "OOC to wszystko co NIE JEST zwiπzane z twojπ postaciπ.(np. twoja szko≥a).");
				SendClientMessage(i, COLOR_WHITE, "OOC to wszytskie rzeczy zwiπzane z tobπ w realu, oraz z komendami, adminami itp.");
				SendClientMessage(i, COLOR_WHITE, "Rzeczy OOC piszemy w chatach: /b /o /i oraz /ro i /depo");
				SendClientMessage(i, COLOR_WHITE, "Poprawnie napisany tekst OOC: /b elo, jesteú adminem? /b jak tam w szkole? itp.");
			}
			...
			{
				SendClientMessage(i, COLOR_WHITE, "Musisz teø wiedzieÊ co to jest IC, oraz poprawnie to interpretowaÊ.");
				SendClientMessage(i, COLOR_WHITE, "IC to tak jakby przeciwnoúÊ OOC. To wszystko co JEST zwiπzane z twojπ postaciπ.");
				SendClientMessage(i, COLOR_WHITE, "Rzeczy IC piszemy w chatach: /l /s /k /t /ad oraz w zwyk≥ym chacie itp.");
				SendClientMessage(i, COLOR_WHITE, "Poprawnie napisany teskt IC: /l witam pana /k staÊ policja, rÍce do gÛry! itp.");
			}
			...
			else if(TutTime[i] == 98)
			{
				...
				SendClientMessage(i, COLOR_WHITE, "Czyli widzisz nick nad g≥owπ gracza i mÛwisz do niego na chacie IC po imieniu");
				SendClientMessage(i, COLOR_WHITE, "Lub wtedy gdy ktoú mÛwi na /b jestem liderem LCN, a ty siÍ go pytasz o pracÍ w LCN");
				SendClientMessage(i, COLOR_WHITE, "PG - to zmuszanie kogoú do akcji RP, mimo iø ta osoba tego nie chce.");
				SendClientMessage(i, COLOR_WHITE, "Czyli np. ktoú podchodzisz do kogoú i dajesz /me bije Johna tak øe umiera, to jest PG.");
			}
			else if(TutTime[i] == 112)
			{
				...
				SendClientMessage(i, COLOR_PURPLE, "|____ Tutorial: zakoÒczenie ____|");
			}
			else if(TutTime[i] == 114)
			{
				SendClientMessage(i, COLOR_WHITE, "Masz sie trzymac wymienionych zasad zrozumiano?.");
				SendClientMessage(i, COLOR_WHITE, "Poprostu pamiÍtaj o nich i ciesz siÍ grπ, a jak nie... ");
				SendClientMessage(i, COLOR_WHITE, "zapewne masz jeszcze sporo pytaÒ dotyczπcych gry, znajdziesz na nie odpowiedü");
				SendClientMessage(i, COLOR_WHITE, "na specjalnym kanale stworzonym dla nowych graczy. Po prostu wpisz /n [swoje pytanie]");
				SendClientMessage(i, COLOR_WHITE, "To juø koniec samouczka, lecz zasad jest jeszcze wiele. znajdziesz je na forum.");
			}
			...
			else if(TutTime[i] == 125)
			{
				...
				SendClientMessage(i, COLOR_NEWS, "A teraz wybierz, jak ma wyglπdaÊ twoja postaÊ.");
				...
				if(trigger)
				{
					if(Lost == 1)
					{
						if(IsPlayerConnected(Boxer1) && IsPlayerConnected(Boxer2))
						{
								...
								if(IsPlayerConnected(TBoxer))
								{
									if(TBoxer != Boxer2)
									{
										if(PlayerInfo[Boxer2][pJob] == 12)
										{
											...
											SaveBoxer();
											format(string, sizeof(string), "Boks News: %s wygra≥ walkÍ z Mistrzem %s i teraz to ON jest Mistrzem Boksu.",  titel, loser);
											OOCOff(COLOR_WHITE,string);
										}
										else
										{
											SendClientMessage(Boxer2, COLOR_LIGHTBLUE, "* zosta≥byú mistrzem bokserskim gdybyú mia≥ pracÍ boxera !");
										}
									}
									else
									{
										GetPlayerName(TBoxer, titel, sizeof(titel));
										format(string, sizeof(string), "Boks News: Mistrz boksu %s wygra≥ walkÍ z %s.",  titel, loser);
										OOCOff(COLOR_WHITE,string);
										Titel[TitelWins] = PlayerInfo[TBoxer][pWins];
							...
							format(string, sizeof(string), "* Przegra≥eú walkÍ z %s.", winner);
							SendClientMessage(Boxer1, COLOR_LIGHTBLUE, string);
							GameTextForPlayer(Boxer1, "~r~you lost", 3500, 1);
							format(string, sizeof(string), "* Wygra≥eú walkÍ z %s.", loser);
							SendClientMessage(Boxer2, COLOR_LIGHTBLUE, string);
							GameTextForPlayer(Boxer2, "~r~Wygrales", 3500, 1);
							if(GetPlayerHealth(Boxer1, health) < 20)
							{
								SendClientMessage(Boxer1, COLOR_LIGHTBLUE, "* Czujesz siÍ wyczerpany, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer1, 30.0);
							}
							else
							{
								SendClientMessage(Boxer1, COLOR_LIGHTBLUE, "* Czujesz siÍ wspaniale, pomimo odbytego pojedynku.");
								SetPlayerHealth(Boxer1, 50.0);
							}
							if(GetPlayerHealth(Boxer2, health) < 10)
							{
								SendClientMessage(Boxer2, COLOR_LIGHTBLUE, "* Czujesz siÍ wykoÒczony, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer2, 30.0);
							}
							else
							{
								SendClientMessage(Boxer2, COLOR_LIGHTBLUE, "* Czujesz siÍ wspaniale, pomimo odbytego pojedynku.");
					...
					else if(Lost == 2)
					{
						if(IsPlayerConnected(Boxer1) && IsPlayerConnected(Boxer2))
						{
							...
							if(TBoxer < 255)
							{
								if(IsPlayerConnected(TBoxer))
								{
									if(TBoxer != Boxer1)
									{
										...
										{
											SendClientMessage(Boxer1, COLOR_LIGHTBLUE, "* zosta≥byú mistrzem bokserskim gdybyú mia≥ pracÍ boxera !");
										}
									}
									else
									{
							...
							{
								SendClientMessage(Boxer2, COLOR_LIGHTBLUE, "* Czujesz siÍ wyczerpany, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer2, 30.0);
							}
							else
							{
		...
		if(StartingPaintballRound == 1 && AnnouncedPaintballRound == 0)
		{
			...
			{
				SendClientMessage(i, COLOR_YELLOW, "Mecz Pintball`u rozpocznie siÍ za 15 sekund (Aby do≥πczy≥o wiÍcej uczestnikÛw).");
			}
		}
		if(StartingKartRound == 1 && AnnouncedKartRound == 0)
		{
			...
			{
				SendClientMessage(i, COLOR_YELLOW, "Wyúcig gokartÛw rozpocznie siÍ za 15 sekund (Aby do≥πczy≥o wiÍcej uczestnikÛw).");
			}
		}
		...
		if(PlayerCuffed[i] == 2 || PlayerCuffed[i] == 3 || PlayerTied[i] == 1)
		{
			if(PlayerCuffedTime[i] <= 0)
			{
				...
				format(string, sizeof(string), "* %s po wielu prÛbach poluzowa≥ sznur i jest wolny.", winner);
				ProxDetector(30.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
	...
	foreach(Player, i)
   	{
		...
		if(Refueling[i] == 1)
		{
			...
			{
				format(string,sizeof(string),"Nie posiadasz doúÊ pieniÍdzy ($%d) aby zatankowaÊ ten pojazd.",FillUp);
...
public CarCheck()
{
	...
	foreach(Player, j)
	{
        if(kaska[j] < 0)
		{
			if(MoneyMessage[j]==0)
			{
				format(string, sizeof(string), "Masz d≥ugi, musisz zarobiÊ do nastÍpnej wyp≥aty $%d inaczej naúlemy na ciebie policje.",PlayerInfo[j][pCash]);
        ...
        if(PlayerInfo[j][pCarLic] > 1000)
        {
            if(lTime > PlayerInfo[j][pCarLic])
            {
                ...
                SendClientMessage(j, COLOR_LIGHTRED, "Blokada licencji na prowadzenie pojazdu minÍ≥a!");
            }
        }
	}	
    //Kolczatki 23.08
