...
public Naprawa(playerid)
{
	...
	{
		sendTipMessage(playerid, "Nie staÊ ciÍ na naprawÍ wozu");
		sendTipMessage(RepairOffer[playerid], "Tej osoby nie staÊ na naprawÍ wozu");
		RepairOffer[playerid] = 999;
    	RepairPrice[playerid] = 0;
		Naprawiasie[playerid] = 0;
		return 0;
	}
	format(string, sizeof(string), "* TwÛj samochÛd zosta≥ naprawiony za $%d(+$%d) przez %s.",RepairPrice[playerid],cena,giveplayer);
			...
			if(IsPlayerInRangeOfPoint(i, 7.0, 2064.0703,-1831.3167,13.3853) || IsPlayerInRangeOfPoint(i, 7.0, 1024.8514,-1022.2302,31.9395) || IsPlayerInRangeOfPoint(i, 7.0, 486.9398,-1742.4130,10.9594) || IsPlayerInRangeOfPoint(i, 7.0, -1904.2325,285.3743,40.8843)  || IsPlayerInRangeOfPoint(i, 7.0, 720.0876,-458.3574,16.3359))
			{
				if(naprawiony[i] == 0)
				{
					...
					if(health <= 999)
					{
				        ...
				        sendTipMessageFormat(i, "Zap≥aci≥eú $%d za wizytÍ w warsztacie", cena);
				        //DajKase(i, -cena);
				        ZabierzKase(i, cena);
