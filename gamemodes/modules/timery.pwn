...
//Zabieranie broni po 2 minutach, jeúli gracz dosta≥ AJ z DM2
...
public BronieAJDM2(playerid)
{
	...
	if(minutyZabierzDM[playerid] == 2)
	{
		...
		sendTipMessage(playerid, "Marcepan Marks mÛwi: Nie ≥adnie jest strzelaÊ do przyjaciÛ≥ bez powodu! Odbieram Ci broÒ.");
