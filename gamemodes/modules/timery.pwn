    ...
    foreach(Player, i)
	{
        ...
        if(GetPVarInt(i, "budka-used") != 999) {
            ...
            if(GetPlayerDistanceFromPoint(i, budki[budkaid][b_x], budki[budkaid][b_y], budki[budkaid][b_z]) > 3.5) {
                sendTipMessage(i, "Oddali≥eú siÍ zbytnio od budki, po≥πczenie przerwane...", COLOR_PAPAYAWHIP);
                ...
                if(GetPVarInt(caller, "budka-Mobile") == i) {
                    sendTipMessage(caller, "**biiip biiip** po≥πczenie zosta≥o przerwane...", COLOR_PAPAYAWHIP);
