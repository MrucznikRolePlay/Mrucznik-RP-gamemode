			...
			if(OrderReady[i] > 0)
			{
				switch (OrderReady[i])
				{
				    case 1:
					{
						...
						_MruAdmin(i, "Odebra≥eú swoje zamÛwienie");
					}
					case 2:
					{
				...
				if(trigger)
				{
					if(Lost == 1)
					{
						if(IsPlayerConnected(Boxer1) && IsPlayerConnected(Boxer2))
						{
							...
							if(TBoxer < 255)
							{
								if(IsPlayerConnected(TBoxer))
								{
									if(TBoxer != Boxer2)
									{
										...
										{
											_MruGracz(Boxer2, "* Zosta≥byú mistrzem bokserskim gdybyú mia≥ pracÍ boksera!");
										}
									}
									else
									{
							...
							{
								_MruGracz(Boxer1, "* Czujesz siÍ wyczerpany, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer1, 30.0);
							}
							else
							{
								_MruGracz(Boxer1, "* Czujesz siÍ wspaniale, pomimo odbytego pojedynku.");
								SetPlayerHealth(Boxer1, 50.0);
							}
							if(GetPlayerHealth(Boxer2, health) < 10)
							{
								_MruGracz(Boxer2, "* Czujesz siÍ wykoÒczony, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer2, 30.0);
							}
							else
							{
								_MruGracz(Boxer2, "* Czujesz siÍ wspaniale, pomimo odbytego pojedynku.");
					...
					else if(Lost == 2)
					{
						if(IsPlayerConnected(Boxer1) && IsPlayerConnected(Boxer2))
						{
							...
							if(TBoxer < 255)
							{
								if(IsPlayerConnected(TBoxer))
								{
									if(TBoxer != Boxer1)
									{
										...
										{
											_MruGracz(Boxer1, "* Zosta≥byú mistrzem bokserskim gdybyú mia≥ pracÍ boksera !");
										}
									}
									else
									{
							...
							{
								_MruGracz(Boxer2, "* Czujesz siÍ wyczerpany, idü coú zjeúÊ.");
								SetPlayerHealth(Boxer2, 30.0);
							}
							else
							{
