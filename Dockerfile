...
RUN wget http://security.ubuntu.com/ubuntu/pool/main/o/openssl1.0/libssl1.0.0_1.0.2n-1ubuntu5.6_i386.deb
RUN dpkg -i libssl1.0.0_1.0.2n-1ubuntu5.6_i386.deb
